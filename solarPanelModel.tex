...
Combinando as equações apresentadas, obtem-se a equação \ref{eq:relacao_corrente_tensao_celula_com_parametros}, que mostra a relação entre a corrente e a tensão da célula solar a partir dos parâmetros do circuito equivalente.
...
\begin{center}
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[xlabel = {V [\SI{}{\volt}]}, ylabel = {I [\SI{}{\watt}]}, ymin = 0, yticklabel style={/pgf/number format/fixed}, xtick distance=1, legend pos = north west, legend style = {font=\scriptsize}, scale = 0.5, scale only axis]
...
\pgfplotstableread[col sep = comma]{figures/solarModelCurve1-5A.csv}\solarPanelModelOnePointFive
\pgfplotstableread[col sep = comma]{figures/solarMeasuredCurve1-5A.csv}\solarPanelMeasuredOnePointFive
\pgfplotstableread[col sep = comma]{figures/solarModelCurve5A.csv}\solarPanelModelFive
\pgfplotstableread[col sep = comma]{figures/solarMeasuredCurve5A.csv}\solarPanelMeasuredFive
\pgfplotstableread[col sep = comma]{figures/solarModelCurve8-5A.csv}\solarPanelModelEightPointFive
\pgfplotstableread[col sep = comma]{figures/solarMeasuredCurve8-5A.csv}\solarPanelMeasuredEightPointFive

\begin{figure}[!htpb]
\begin{minipage}{.5\textwidth}
\begin{center}
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[xlabel = {V [\SI{}{\volt}]}, ylabel = {I [\SI{}{\ampere}]}, ymin = 0, yticklabel style={/pgf/number format/fixed}, xtick distance=1, legend pos = south west, scale = 0.5, legend style = {font=\scriptsize}, scale only axis]
\addplot[mark = none, color = cyan] table[x index = {0}, y index = {1}]{\solarPanelModelOnePointFive};
\addplot[mark = none, color = red, dashed] table[x index = {0}, y index = {1}]{\solarPanelMeasuredOnePointFive};
\addlegendentry{Curva do Modelo}
\addlegendentry{Curva Medida}
\end{axis}
\end{tikzpicture}
\caption{Curvas para \SI[per-mode=symbol]{150}{\watt\per\square\meter}}
...
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[xlabel = {V [\SI{}{\volt}]}, ylabel = {I [\SI{}{\ampere}]}, ymin = 0, yticklabel style={/pgf/number format/fixed}, xtick distance=1, legend pos = south west, legend style = {font=\scriptsize}, scale = 0.5, scale only axis]
\addplot[mark = none, color = cyan] table[x index = {0}, y index = {1}]{\solarPanelModelFive};
\addplot[mark = none, color = red, dashed] table[x index = {0}, y index = {1}]{\solarPanelMeasuredFive};
\addlegendentry{Curva do Modelo}
\addlegendentry{Curva Medida}
\end{axis}
\end{tikzpicture}
\caption{Curvas para \SI[per-mode=symbol]{450}{\watt\per\square\meter}}
...
\begin{tikzpicture}[trim axis left, trim axis right]
\begin{axis}[xlabel = {V [\SI{}{\volt}]}, ylabel = {I [\SI{}{\ampere}]}, ymin = 0, yticklabel style={/pgf/number format/fixed}, xtick distance=1, legend pos = south west, legend style = {font=\scriptsize}, scale = 0.5, scale only axis]
\addplot[mark = none, color = cyan] table[x index = {0}, y index = {1}]{\solarPanelModelEightPointFive};
\addplot[mark = none, color = red, dashed] table[x index = {0}, y index = {1}]{\solarPanelMeasuredEightPointFive};
\addlegendentry{Curva do Modelo}
\addlegendentry{Curva Medida}
\end{axis}
\end{tikzpicture}
