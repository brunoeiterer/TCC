...
A potência consumida pelas cargas foi simulada através de uma fonte de corrente controlada pelo modelo da seção \ref{secao:modelagem_cargas} e alimentada por um conversor DC-DC ideal.
